...
import cimav.client.data.domain.EmpleadoDummy;
...
public class BindableProxyLoaderImpl implements BindableProxyLoader { public void loadBindableProxies() {
    ...
    class cimav_client_data_domain_EmpleadoDummyProxy extends EmpleadoDummy implements BindableProxy {
      private BindableProxyAgent<EmpleadoDummy> agent;
      public cimav_client_data_domain_EmpleadoDummyProxy(InitialState initialState) {
        this(new EmpleadoDummy(), initialState);
      }

      public cimav_client_data_domain_EmpleadoDummyProxy(EmpleadoDummy target, InitialState initialState) {
        agent = new BindableProxyAgent<EmpleadoDummy>(this, target, initialState);
      ...
      public EmpleadoDummy unwrap() {
        return agent.target;
      }

      public EmpleadoDummy deepUnwrap() {
        final EmpleadoDummy clone = new EmpleadoDummy();
      ...
      public boolean equals(Object obj) {
        if (obj instanceof cimav_client_data_domain_EmpleadoDummyProxy) {
          obj = ((cimav_client_data_domain_EmpleadoDummyProxy) obj).unwrap();
        }
        return agent.target.equals(obj);
      }
    ...
    BindableProxyFactory.addBindableProxy(EmpleadoDummy.class, new BindableProxyProvider() {
      public BindableProxy getBindableProxy(Object model, InitialState state) {
        return new cimav_client_data_domain_EmpleadoDummyProxy((EmpleadoDummy) model, state);
      }
      public BindableProxy getBindableProxy(InitialState state) {
        return new cimav_client_data_domain_EmpleadoDummyProxy(state);
      }
    });
