...
public class PickList extends Composite {
    ...
    public PickList() {
        ...
        setLeftListElements(new ArrayList<Concepto>());
        setRightListElements(new ArrayList<Concepto>());
    }
    ...
    public void addElementToLeftList(Concepto element) {
        addElement(leftList, element);
    }

    public void addElementToRightList(Concepto element) {
        addElement(rightList, element);
    }

    private void addElement(ListBox listBox, Concepto element) {
        listBox.addItem(element.getCode(), element.getName());
    }

    public List<Concepto> getLeftListElements() {
        return getListBoxElements(leftList);
    }

    public void setLeftListElements(List<Concepto> elements) {
        populate(elements, leftList);
    }

    public List<Concepto> getRightListElements() {
        return getListBoxElements(rightList);
    }

    public void setRightListElements(List<Concepto> elements) {
    ...
    private List<Concepto> getListBoxElements(ListBox listBox) {
        ArrayList<Concepto> nameValuePairs = new ArrayList<Concepto>();
...
//            nameValuePairs.add(nameValuePair);
    ...
    private void populate(List<Concepto> leftListElements, ListBox listBox) {
        for (Concepto element : leftListElements) {
            listBox.addItem(element.getCode(), element.getName());
        }
    }
