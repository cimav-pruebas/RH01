...
public class Ajax {
    ...
    private static final List<AsyncCallback<?>> callstack = new ArrayList<>();
    ...
    private static final List<JsonCallback> jsonCallStack = new ArrayList<>();
